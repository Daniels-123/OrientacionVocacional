...
public class ahorcadobomb extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahorcadobomb);
        setRandomWord();
    }
    ...
    public void checkLetter(String letter) {
        ...
        if (aciertos == mWord.length()) {
            ...
            alertDialog4.setIcon(R.mipmap.bombero);
            alertDialog4.show();
    ...
    public void letterFailed(String letter){
        ...
        switch (nFails) {
            ...
            case 8:
                ...
                alertDialog.setIcon(R.mipmap.bombero);
                alertDialog.show();
    ...
    public void setRandomWord(){
        String words = "INCENDIO AGILIDAD ";
