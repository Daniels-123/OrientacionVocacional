...
public class ahorcadoingen extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahorcadoingen);
        setRandomWord();
    }
    ...
    public void checkLetter(String letter) {
        ...
        if (aciertos == mWord.length()) {
            ...
            alertDialog4.setIcon(R.mipmap.ingeniero);
            alertDialog4.show();
    ...
    public void letterFailed(String letter){
        ...
        switch (nFails) {
            ...
            case 8:
                ...
                alertDialog.setIcon(R.mipmap.ingeniero);
                alertDialog.show();
    ...
    public void setRandomWord(){
        String words = "RESOLVER PROBLEMA ";
