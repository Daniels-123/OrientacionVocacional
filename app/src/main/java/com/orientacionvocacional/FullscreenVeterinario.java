 ...
 */
public class FullscreenVeterinario extends AppCompatActivity {
    ...
    String videoSource =
            "rtsp://r9---sn-q4f7snly.googlevideo.com/Cj0LENy73wIaNAkwX-bqm56JLBMYDSANFC0ssURXMOCoAUIASARg2YjbtbTPq6JXigELTGpqb1RJRjIzZDgM/57268AB2C22321C1A0B3988ED8992D302C73E919.C3C645BC64825FC3C916CD7961D902FAB82ADF09/yt6/1/video.3gp";
    Uri uriVideoSource;

    String videoSource2=
            "rtsp://r5---sn-q4f7snl7.googlevideo.com/Cj0LENy73wIaNAngen4z4xtmhxMYDSANFC0NsURXMOCoAUIASARg2YjbtbTPq6JXigELTGpqb1RJRjIzZDgM/223ABA371889343DF2945C885A17261011EF9F21.B78BEDC7749A86783E981DB132097C8E0E50BC49/yt6/1/video.3gp";
    Uri uriVideoSource2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_fullscreen_veterinario);
        ...
        findViewById(R.id.button4).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(FullscreenVeterinario.this, Profesiones.class));
            }
        });
        findViewById(R.id.button5).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(FullscreenVeterinario.this, ahorcadovete.class));
            }
        });
    }
    ...
    MediaPlayer.OnCompletionListener myVideoViewCompletionListener =
            new MediaPlayer.OnCompletionListener() {
                ...
                public void onCompletion(MediaPlayer arg0) {
                    Toast.makeText(FullscreenVeterinario.this, "Por favor regrese a la anterior pantalla",
    ...
    MediaPlayer.OnPreparedListener MyVideoViewPreparedListener =
            new MediaPlayer.OnPreparedListener() {
                ...
                public void onPrepared(MediaPlayer mp) {
                    ...
                    Toast.makeText(FullscreenVeterinario.this,
