...
public class ahorcadomedi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahorcadomedi);
        setRandomWord();
    }
    ...
    public void checkLetter(String letter) {
        ...
        if (aciertos == mWord.length()) {
            ...
            alertDialog4.setIcon(R.mipmap.medico);
            alertDialog4.show();
    ...
    public void letterFailed(String letter){
        ...
        switch (nFails) {
            ...
            case 8:
                ...
                alertDialog.setIcon(R.mipmap.medico);
                alertDialog.show();
    ...
    public void setRandomWord(){
        String words = "URGENCIA HOSPITAL ";
