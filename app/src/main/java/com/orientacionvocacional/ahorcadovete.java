...
public class ahorcadovete extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahorcadovete);
        setRandomWord();
    }
    ...
    public void checkLetter(String letter) {
        ...
        if (aciertos == mWord.length()) {
            ...
            alertDialog4.setIcon(R.mipmap.veterinario);
            alertDialog4.show();
    ...
    public void letterFailed(String letter){
        ...
        switch (nFails) {
            ...
            case 8:
                ...
                alertDialog.setIcon(R.mipmap.veterinario);
                alertDialog.show();
    ...
    public void setRandomWord(){
         String words = "ANIMALES ENFERMOS ";
