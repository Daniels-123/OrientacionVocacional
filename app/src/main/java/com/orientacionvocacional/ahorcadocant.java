...
public class ahorcadocant extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ahorcadocant);
        setRandomWord();
    }
    ...
    public void checkLetter(String letter) {
        ...
        if (aciertos == mWord.length()) {
            ...
            alertDialog4.setIcon(R.mipmap.cantante1);
            alertDialog4.show();
    ...
    public void letterFailed(String letter){
        ...
        switch (nFails) {
            ...
            case 8:
                ...
                alertDialog.setIcon(R.mipmap.cantante1);
                alertDialog.show();
    ...
    public void setRandomWord(){
        String words = "CANTANTE BAILARIN ";
